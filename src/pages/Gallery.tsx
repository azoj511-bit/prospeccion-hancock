...
export const Gallery: React.FC = () => {
  ...
  const mediaItems: MediaItem[] = [
    ...
    {
      id: 31,
      url: '/img/captures/capture-01.png',
      type: 'image',
      title: 'Campamento Minero y Comunidad en Pilbara, Outback Australiano',
      category: 'Institucional',
      year: 2026,
    },
    {
      id: 32,
      url: '/img/captures/capture-02.png',
      type: 'image',
      title: 'Sra. Gina Rinehart AO en la Sede de Hancock Prospecting con Sombrero S. Kidman',
      category: 'Institucional',
      year: 2026,
    },
    {
      id: 33,
      url: '/img/captures/capture-03.png',
      type: 'image',
      title: 'Gina Rinehart AO – Entrevista Institucional y Mensaje de Bienvenida',
      category: 'Institucional',
      year: 2026,
    },
    {
      id: 34,
      url: '/img/captures/capture-04.png',
      type: 'image',
      title: 'Discurso Magistral en Concierto de Gala con la Orquesta Sinfónica Australiana',
      category: 'Cultura',
      year: 2025,
    },
    {
      id: 35,
      url: '/img/captures/capture-05.png',
      type: 'image',
      title: 'Encuentro Diplomático y Alianza de Inversión Internacional Hancock Prospecting',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 36,
      url: '/img/captures/capture-06.png',
      type: 'image',
      title: 'Delegación Oficial y Cena de Estado en Tokio, Japón con Socios Industriales',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 37,
      url: '/img/captures/capture-07.png',
      type: 'image',
      title: 'Comité Ejecutivo de Hancock Prospecting con Líderes Industriales de Asia',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 38,
      url: '/img/captures/capture-08.png',
      type: 'image',
      title: 'Inauguración Oficial del Proyecto Energético Senex Energy con Corte de Cinta',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 39,
      url: '/img/captures/capture-09.png',
      type: 'image',
      title: 'Discurso Inaugural de Gina Rinehart en el Yacimiento de Desarrollo Energético',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 40,
      url: '/img/captures/capture-10.png',
      type: 'image',
      title: 'Celebración Oficial del National Mining Day con el Equipo de Hancock Iron Ore',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 41,
      url: '/img/captures/capture-11.png',
      type: 'image',
      title: 'Encuentro de Alto Nivel con el Presidente Javier Milei – Cooperación Minera',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 42,
      url: '/img/captures/capture-12.png',
      type: 'image',
      title: 'Cena de Gala Internacional con Líderes Políticos y Filantrópicos',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 43,
      url: '/img/captures/capture-13.png',
      type: 'image',
      title: 'Recepción Oficial de Honor y Alianzas Filantrópicas Globales',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 44,
      url: '/img/captures/capture-14.png',
      type: 'image',
      title: 'Presentación del Patrimonio Histórico y Tradición de S. Kidman & Co',
      category: 'Cultura',
      year: 2025,
    },
    {
      id: 45,
      url: '/img/captures/capture-15.png',
      type: 'image',
      title: 'Discurso de Gina Rinehart ante Ganaderos y Comunidades del Outback',
      category: 'Cultura',
      year: 2025,
    },
    {
      id: 46,
      url: '/img/captures/capture-16.png',
      type: 'image',
      title: 'Mensaje Institucional sobre Soberanía Productiva y Desarrollo Regional',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 47,
      url: '/img/captures/capture-17.png',
      type: 'image',
      title: 'Conferencia sobre Liderazgo Femenino en la Gran Minería y Ganadería',
      category: 'Institucional',
      year: 2025,
    },
    {
      id: 48,
      url: '/img/captures/capture-18.png',
      type: 'image',
      title: 'Patrimonio Rural y Ganadero Australiano - Colección Histórica S. Kidman',
      category: 'Cultura',
      year: 2025,
    },
    {
      id: 49,
      url: '/img/captures/capture-19.png',
      type: 'image',
      title: 'Presentación de Productos Rurales de Calidad y Calzado S. Kidman & Co',
      category: 'Cultura',
      year: 2025,
    },
    {
      id: 50,
      url: '/img/captures/capture-20.png',
      type: 'image',
      title: 'Colección Tradicional de Ropa y Botas S. Kidman – Ganadería Australiana',
      category: 'Cultura',
      year: 2025,
    }
  ];
